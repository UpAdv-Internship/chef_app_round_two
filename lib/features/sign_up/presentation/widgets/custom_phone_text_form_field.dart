...
class CustomPhoneTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomTextFormField(
      ...
      lable: AppStrings.phoneNumber,
      keyboardType: TextInputType.phone,
      validate: (value) {
        if (value!.isEmpty) {
          return "هذا الحقل مطلوب";
        } else if (value.length != 11) {
          return "هذا الرقم غير صحيح يجب ان يتكون من 11 رقم";
        } else if (value.startsWith("01") == false) {
          return "هذا الرقم غير صحيح , تبدأ الارقام الصحيحه ب 01";
            ...
            value.contains(";") ||
            value.contains(")")) {
          return "هذا الرقم غير صحيح , تأكد من رقم هاتفك";
        }
        return null;
      },
    );
