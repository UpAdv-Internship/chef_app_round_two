...
class RequierdFrontIDFileItem extends StatelessWidget {
  const RequierdFrontIDFileItem({super.key});
  @override
        ...
        return Row(
          ...
          children: [
            ...
            IconButton(
              ...
              icon: Icon(
                signupCubit.frontId != null ? Icons.done : Icons.camera,
                color: AppColors.primary,
              ),
            )
          ],
