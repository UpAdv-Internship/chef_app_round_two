...
class RequierdhealthCertificateFileItem extends StatelessWidget {
  const RequierdhealthCertificateFileItem({
    super.key,
  });
    ...
    return BlocConsumer<SignUpCubit, SignUpState>(
      ...
      builder: (context, state) {
        return Row(
          ...
          children: [
            Text(
              AppStrings.healthCertificate.tr(context),
                              ...
                              onTap: () {
                                ImagePicker()
                                    ...
                                    .then((value) => signupCubit
                                        .changehealthCertificatePicImage(
                                            value));
